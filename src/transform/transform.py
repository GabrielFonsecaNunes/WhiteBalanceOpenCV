...
from src.transform.train_model_regressor import TrainModelRegressor
import os
...
class Transform:
    def __init__(self, frame):
        ...
        """
        self.frame = frame
        self.model_path = './src/transform/models/'
    ...
    def load_model(self, model_name):
        ...
        #     file_path = rf"{os.path.dirname(script_path)}\{model_name}."
        #     print(file_path)
...
if __name__ == '__main__':
    img_path = "./resources/img/avatar3.jpeg"
    ...
    img_temp_lower = transform.modify_temperature(-1500)
    img_temp_higher = transform.modify_temperature(1500)
