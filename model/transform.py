...
class Transform:
    def __init__(self, frame):
        ...
        self.BGR2TEMP_model = self.load_model('model_regressor_rgb2temp')
        self.TEMP2BGR_model = self.load_model('model_regressor_temp2rgb')
    ...
    def black_mask(self, img_rgb):
        ...
        """
        black_pixels = np.logical_and.reduce(img_rgb[:, :, :3] <= 150, axis=-1)
